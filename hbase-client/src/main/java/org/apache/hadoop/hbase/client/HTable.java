...
//	LOG.info("********************start scan in htable-"+scan.toString()+"-"+System.nanoTime());
    ...
    if (scan.isReversed()) {
      if (scan.isSmall()) {
//    	  LOG.info("********************isReversed isSmall-"+scan.toString()+"-"+System.nanoTime());
        return new ClientSmallReversedScanner(getConfiguration(), scan, getName(),
            this.connection, this.rpcCallerFactory, this.rpcControllerFactory,
            pool, tableConfiguration.getReplicaCallTimeoutMicroSecondScan());
      } else {
//    	  LOG.info("*******************isReversed not Small-"+scan.toString()+"-"+System.nanoTime());
    ...
    if (scan.isSmall()) {
//    	 LOG.info("*******************not Reversed isSmall-"+scan.toString()+"-"+System.nanoTime());
      return new ClientSmallScanner(getConfiguration(), scan, getName(),
          this.connection, this.rpcCallerFactory, this.rpcControllerFactory,
          pool, tableConfiguration.getReplicaCallTimeoutMicroSecondScan());
    } else {
//    	 LOG.info("*******************not Reversed not Small-"+scan.toString()+"-"+System.nanoTime());
...
//	LOG.info("********************************start get in htable-"+get.toString()+"-"+System.nanoTime());
