...
public class CellSkipListSet implements NavigableSet<Cell> {
  ...
  public boolean add(Cell e) {
	  ...
	  /*****************************************************************/
//	  System.out.println("&&&&&&&&&&&&&&&&&&&& come in method in add in CellSkipListSet: "+delegatee.size());
//	    for(Entry<Cell, Cell> entry: delegatee.entrySet()){
//	    	Cell key = entry.getKey();
//	    	Cell value = entry.getValue();
//	    	System.out.println(Bytes.toString(CellUtil.cloneFamily(key))+","+Bytes.toString(CellUtil.cloneQualifier(key))+","
//	    			+Bytes.toString(CellUtil.cloneValue(key)));
//	    	System.out.println(Bytes.toString(CellUtil.cloneFamily(value))+","+Bytes.toString(CellUtil.cloneQualifier(value))+","
//	    			+Bytes.toString(CellUtil.cloneValue(value)));
//	    }
	    /*****************************************************************/
