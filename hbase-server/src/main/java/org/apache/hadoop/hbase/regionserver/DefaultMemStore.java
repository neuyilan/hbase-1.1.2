...
public class DefaultMemStore implements MemStore {
  ...
  private boolean addToCellSet(Cell e) {
    ...
    /*****************************************************************/
//    Iterator<Cell> iterator = cellSet.iterator();
//    System.out.println("&&&&&&&&&&&&&&&&&&&& come in method in addToCellSet in DefaultMemStore: "+cellSet.size());
//    while(iterator.hasNext()){
//    	Cell tempCell = iterator.next();
//    	System.out.println(Bytes.toString(CellUtil.cloneFamily(tempCell))+","+Bytes.toString(CellUtil.cloneQualifier(tempCell))+","
//    			+Bytes.toString(CellUtil.cloneValue(tempCell)));
//    }
    /*****************************************************************/
